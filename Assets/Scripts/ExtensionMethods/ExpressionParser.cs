...
namespace B83.ExpressionParser {
    ...
    public class OperationSum : IValue {
        ...
        public double Value {
            get {
                return m_Values.Select(v => v.Value).Sum();
            }
        }
    ...
    public class OperationProduct : IValue {
        ...
        public double Value {
            get {
                return m_Values.Select(v => v.Value).Aggregate((v1, v2) => v1 * v2);
            }
        }
    ...
    public class OperationPower : IValue {
        ...
        public double Value {
            get {
                return System.Math.Pow(m_Value.Value, m_Power.Value);
            }
        }
    ...
    public class MultiParameterList : IValue {
        ...
        public double Value {
            get {
                return m_Values.Select(v => v.Value).FirstOrDefault();
            }
        }
    ...
    public class CustomFunction : IValue {
        ...
        public CustomFunction(string aName, System.Func<double[], double> aDelegate,
                              params IValue[] aValues) {
    ...
    public class ExpressionParser {
        ...
        private Dictionary<string, System.Func<double>> m_Consts = new
        Dictionary<string, System.Func<double>>();
        private Dictionary<string, System.Func<double[], double>> m_Funcs = new
        Dictionary<string, System.Func<double[], double>>();
        ...
        IValue Parse(string aExpression) {
            ...
            if (index2a >= 0 && index2b >= 2) {
                ...
                if (int.TryParse(inner, out bracketIndex) && bracketIndex >= 0
